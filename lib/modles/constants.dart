class Constants{
  ...
  static final String foodPhotoColumnName = 'photo';
  static final String heightColumnName = 'height';
  static final String weightColumnName = 'weight';
  static final String statusColumnName = 'status';
  static final String dateColumnName = 'date';
  static final String timeColumnName = 'time';
}
